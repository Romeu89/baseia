...
**Status:** Partial. Rows for units 2, 3, 4 (locked via SDD). Step 1 collapsed em finding #2 (não é unit, é hypothesis context). Steps 5+ aguardando Phase 1 interview completion.
