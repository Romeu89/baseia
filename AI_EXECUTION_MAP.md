...
**Status:** Partial. Rows for units 2, 3, 4, 5 (locked via SDD). Step 1 collapsed em finding #2 (não é unit, é hypothesis context). Step 6+ aguardando Phase 1 interview completion.
